...
contract DIMORegistryOld is Ownable, AccessControl, ERC721 {
    ...
    /// @dev Owner cannot mint more than one root
    /// @param label The label specifying the root
    function mintRoot(string calldata label) external onlyRole(MINTER_ROLE) {
        require(
    ...
    /// @param _owner The address of the device's owner
