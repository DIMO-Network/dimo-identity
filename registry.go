...
// MintVehicleWithDdInput is an auto generated low-level Go binding around an user-defined struct.
type MintVehicleWithDdInput struct {
	ManufacturerNode   *big.Int
	Owner              common.Address
	DeviceDefinitionId string
	AttrInfo           []AttributeInfoPair
...
// MintVehicleWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0x5675d304.
//
// Solidity: function mintVehicleWithDeviceDefinitionSign((uint256,address,string,(string,string)[],bytes) data) returns()
func (_Registry *RegistryTransactor) MintVehicleWithDeviceDefinitionSign(opts *bind.TransactOpts, data MintVehicleWithDdInput) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "mintVehicleWithDeviceDefinitionSign", data)
}

// MintVehicleWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0x5675d304.
//
// Solidity: function mintVehicleWithDeviceDefinitionSign((uint256,address,string,(string,string)[],bytes) data) returns()
func (_Registry *RegistrySession) MintVehicleWithDeviceDefinitionSign(data MintVehicleWithDdInput) (*types.Transaction, error) {
	return _Registry.Contract.MintVehicleWithDeviceDefinitionSign(&_Registry.TransactOpts, data)
}

// MintVehicleWithDeviceDefinitionSign is a paid mutator transaction binding the contract method 0x5675d304.
//
// Solidity: function mintVehicleWithDeviceDefinitionSign((uint256,address,string,(string,string)[],bytes) data) returns()
func (_Registry *RegistryTransactorSession) MintVehicleWithDeviceDefinitionSign(data MintVehicleWithDdInput) (*types.Transaction, error) {
	return _Registry.Contract.MintVehicleWithDeviceDefinitionSign(&_Registry.TransactOpts, data)
}
...
//
// Solidity: function setDimoTokenAddress(address dimoToken) returns()
func (_Registry *RegistryTransactor) SetDimoTokenAddress(opts *bind.TransactOpts, dimoToken common.Address) (*types.Transaction, error) {
	return _Registry.contract.Transact(opts, "setDimoTokenAddress", dimoToken)
}

// SetDimoTokenAddress is a paid mutator transaction binding the contract method 0x81c9bb13.
//
// Solidity: function setDimoTokenAddress(address dimoToken) returns()
func (_Registry *RegistrySession) SetDimoTokenAddress(dimoToken common.Address) (*types.Transaction, error) {
	return _Registry.Contract.SetDimoTokenAddress(&_Registry.TransactOpts, dimoToken)
}

// SetDimoTokenAddress is a paid mutator transaction binding the contract method 0x81c9bb13.
//
// Solidity: function setDimoTokenAddress(address dimoToken) returns()
func (_Registry *RegistryTransactorSession) SetDimoTokenAddress(dimoToken common.Address) (*types.Transaction, error) {
	return _Registry.Contract.SetDimoTokenAddress(&_Registry.TransactOpts, dimoToken)
}
