...
// IntegrationIdMetaData contains all meta data concerning the IntegrationId contract.
var IntegrationIdMetaData = bind.MetaData{
...
// IntegrationId is an auto generated Go binding around an Ethereum contract.
type IntegrationId struct {
	abi abi.ABI
}

// NewIntegrationId creates a new instance of IntegrationId.
func NewIntegrationId() *IntegrationId {
	parsed, err := IntegrationIdMetaData.ParseABI()
	if err != nil {
		panic(errors.New("invalid ABI: " + err.Error()))
	}
	return &IntegrationId{abi: *parsed}
}

// Instance creates a wrapper for a deployed contract instance at the given address.
// Use this to create the instance object passed to abigen v2 library functions Call, Transact, etc.
func (c *IntegrationId) Instance(backend bind.ContractBackend, addr common.Address) *bind.BoundContract {
...
func (integrationId *IntegrationId) PackADMINROLE() []byte {
	enc, err := integrationId.abi.Pack("ADMIN_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackADMINROLE() ([]byte, error) {
	return integrationId.abi.Pack("ADMIN_ROLE")
}
...
//
// Solidity: function ADMIN_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackADMINROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("ADMIN_ROLE", data)
	if err != nil {
...
func (integrationId *IntegrationId) PackBURNERROLE() []byte {
	enc, err := integrationId.abi.Pack("BURNER_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function BURNER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackBURNERROLE() ([]byte, error) {
	return integrationId.abi.Pack("BURNER_ROLE")
}
...
//
// Solidity: function BURNER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackBURNERROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("BURNER_ROLE", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackDEFAULTADMINROLE() []byte {
	enc, err := integrationId.abi.Pack("DEFAULT_ADMIN_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function DEFAULT_ADMIN_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackDEFAULTADMINROLE() ([]byte, error) {
	return integrationId.abi.Pack("DEFAULT_ADMIN_ROLE")
}
...
//
// Solidity: function DEFAULT_ADMIN_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackDEFAULTADMINROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("DEFAULT_ADMIN_ROLE", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackMINTERROLE() []byte {
	enc, err := integrationId.abi.Pack("MINTER_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function MINTER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackMINTERROLE() ([]byte, error) {
	return integrationId.abi.Pack("MINTER_ROLE")
}
...
//
// Solidity: function MINTER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackMINTERROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("MINTER_ROLE", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackTRANSFERERROLE() []byte {
	enc, err := integrationId.abi.Pack("TRANSFERER_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function TRANSFERER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackTRANSFERERROLE() ([]byte, error) {
	return integrationId.abi.Pack("TRANSFERER_ROLE")
}
...
//
// Solidity: function TRANSFERER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackTRANSFERERROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("TRANSFERER_ROLE", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackUPGRADERROLE() []byte {
	enc, err := integrationId.abi.Pack("UPGRADER_ROLE")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function UPGRADER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) TryPackUPGRADERROLE() ([]byte, error) {
	return integrationId.abi.Pack("UPGRADER_ROLE")
}
...
//
// Solidity: function UPGRADER_ROLE() view returns(bytes32)
func (integrationId *IntegrationId) UnpackUPGRADERROLE(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("UPGRADER_ROLE", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackApprove(to common.Address, tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("approve", to, tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function approve(address to, uint256 tokenId) returns()
func (integrationId *IntegrationId) TryPackApprove(to common.Address, tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("approve", to, tokenId)
}
...
func (integrationId *IntegrationId) PackBalanceOf(owner common.Address) []byte {
	enc, err := integrationId.abi.Pack("balanceOf", owner)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (integrationId *IntegrationId) TryPackBalanceOf(owner common.Address) ([]byte, error) {
	return integrationId.abi.Pack("balanceOf", owner)
}
...
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (integrationId *IntegrationId) UnpackBalanceOf(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("balanceOf", data)
	if err != nil {
...
func (integrationId *IntegrationId) PackBurn(tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("burn", tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function burn(uint256 tokenId) returns()
func (integrationId *IntegrationId) TryPackBurn(tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("burn", tokenId)
}
...
func (integrationId *IntegrationId) PackCreatePrivilege(enabled bool, description string) []byte {
	enc, err := integrationId.abi.Pack("createPrivilege", enabled, description)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function createPrivilege(bool enabled, string description) returns()
func (integrationId *IntegrationId) TryPackCreatePrivilege(enabled bool, description string) ([]byte, error) {
	return integrationId.abi.Pack("createPrivilege", enabled, description)
}
...
func (integrationId *IntegrationId) PackDimoRegistry() []byte {
	enc, err := integrationId.abi.Pack("dimoRegistry")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function dimoRegistry() view returns(address)
func (integrationId *IntegrationId) TryPackDimoRegistry() ([]byte, error) {
	return integrationId.abi.Pack("dimoRegistry")
}
...
//
// Solidity: function dimoRegistry() view returns(address)
func (integrationId *IntegrationId) UnpackDimoRegistry(data []byte) (common.Address, error) {
	out, err := integrationId.abi.Unpack("dimoRegistry", data)
	if err != nil {
...
func (integrationId *IntegrationId) PackDisablePrivilege(privId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("disablePrivilege", privId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function disablePrivilege(uint256 privId) returns()
func (integrationId *IntegrationId) TryPackDisablePrivilege(privId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("disablePrivilege", privId)
}
...
func (integrationId *IntegrationId) PackEnablePrivilege(privId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("enablePrivilege", privId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function enablePrivilege(uint256 privId) returns()
func (integrationId *IntegrationId) TryPackEnablePrivilege(privId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("enablePrivilege", privId)
}
...
func (integrationId *IntegrationId) PackExists(tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("exists", tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function exists(uint256 tokenId) view returns(bool)
func (integrationId *IntegrationId) TryPackExists(tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("exists", tokenId)
}
...
//
// Solidity: function exists(uint256 tokenId) view returns(bool)
func (integrationId *IntegrationId) UnpackExists(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("exists", data)
	if err != nil {
		return *new(bool), err
	}
...
func (integrationId *IntegrationId) PackGetApproved(tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("getApproved", tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (integrationId *IntegrationId) TryPackGetApproved(tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("getApproved", tokenId)
}
...
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (integrationId *IntegrationId) UnpackGetApproved(data []byte) (common.Address, error) {
	out, err := integrationId.abi.Unpack("getApproved", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
func (integrationId *IntegrationId) PackGetRoleAdmin(role [32]byte) []byte {
	enc, err := integrationId.abi.Pack("getRoleAdmin", role)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function getRoleAdmin(bytes32 role) view returns(bytes32)
func (integrationId *IntegrationId) TryPackGetRoleAdmin(role [32]byte) ([]byte, error) {
	return integrationId.abi.Pack("getRoleAdmin", role)
}
...
//
// Solidity: function getRoleAdmin(bytes32 role) view returns(bytes32)
func (integrationId *IntegrationId) UnpackGetRoleAdmin(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("getRoleAdmin", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackGrantRole(role [32]byte, account common.Address) []byte {
	enc, err := integrationId.abi.Pack("grantRole", role, account)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function grantRole(bytes32 role, address account) returns()
func (integrationId *IntegrationId) TryPackGrantRole(role [32]byte, account common.Address) ([]byte, error) {
	return integrationId.abi.Pack("grantRole", role, account)
}
...
func (integrationId *IntegrationId) PackHasPrivilege(tokenId *big.Int, privId *big.Int, user common.Address) []byte {
	enc, err := integrationId.abi.Pack("hasPrivilege", tokenId, privId, user)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function hasPrivilege(uint256 tokenId, uint256 privId, address user) view returns(bool)
func (integrationId *IntegrationId) TryPackHasPrivilege(tokenId *big.Int, privId *big.Int, user common.Address) ([]byte, error) {
	return integrationId.abi.Pack("hasPrivilege", tokenId, privId, user)
}
...
//
// Solidity: function hasPrivilege(uint256 tokenId, uint256 privId, address user) view returns(bool)
func (integrationId *IntegrationId) UnpackHasPrivilege(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("hasPrivilege", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (integrationId *IntegrationId) PackHasRole(role [32]byte, account common.Address) []byte {
	enc, err := integrationId.abi.Pack("hasRole", role, account)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function hasRole(bytes32 role, address account) view returns(bool)
func (integrationId *IntegrationId) TryPackHasRole(role [32]byte, account common.Address) ([]byte, error) {
	return integrationId.abi.Pack("hasRole", role, account)
}
...
//
// Solidity: function hasRole(bytes32 role, address account) view returns(bool)
func (integrationId *IntegrationId) UnpackHasRole(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("hasRole", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (integrationId *IntegrationId) PackInitialize(name string, symbol string, baseUri string, dimoRegistry common.Address, trustedForwarders []common.Address) []byte {
	enc, err := integrationId.abi.Pack("initialize", name, symbol, baseUri, dimoRegistry, trustedForwarders)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function initialize(string name_, string symbol_, string baseUri_, address dimoRegistry_, address[] trustedForwarders_) returns()
func (integrationId *IntegrationId) TryPackInitialize(name string, symbol string, baseUri string, dimoRegistry common.Address, trustedForwarders []common.Address) ([]byte, error) {
	return integrationId.abi.Pack("initialize", name, symbol, baseUri, dimoRegistry, trustedForwarders)
}
...
func (integrationId *IntegrationId) PackIsApprovedForAll(owner common.Address, operator common.Address) []byte {
	enc, err := integrationId.abi.Pack("isApprovedForAll", owner, operator)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (integrationId *IntegrationId) TryPackIsApprovedForAll(owner common.Address, operator common.Address) ([]byte, error) {
	return integrationId.abi.Pack("isApprovedForAll", owner, operator)
}
...
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (integrationId *IntegrationId) UnpackIsApprovedForAll(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("isApprovedForAll", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (integrationId *IntegrationId) PackName() []byte {
	enc, err := integrationId.abi.Pack("name")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function name() view returns(string)
func (integrationId *IntegrationId) TryPackName() ([]byte, error) {
	return integrationId.abi.Pack("name")
}
...
//
// Solidity: function name() view returns(string)
func (integrationId *IntegrationId) UnpackName(data []byte) (string, error) {
	out, err := integrationId.abi.Unpack("name", data)
	if err != nil {
...
func (integrationId *IntegrationId) PackOwnerOf(tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("ownerOf", tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function ownerOf(uint256 tokenId) view returns(address)
func (integrationId *IntegrationId) TryPackOwnerOf(tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("ownerOf", tokenId)
}
...
//
// Solidity: function ownerOf(uint256 tokenId) view returns(address)
func (integrationId *IntegrationId) UnpackOwnerOf(data []byte) (common.Address, error) {
	out, err := integrationId.abi.Unpack("ownerOf", data)
	if err != nil {
		return *new(common.Address), err
	}
	out0 := *abi.ConvertType(out[0], new(common.Address)).(*common.Address)
...
func (integrationId *IntegrationId) PackPrivilegeEntry(arg0 *big.Int, arg1 *big.Int, arg2 *big.Int, arg3 common.Address) []byte {
	enc, err := integrationId.abi.Pack("privilegeEntry", arg0, arg1, arg2, arg3)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function privilegeEntry(uint256 , uint256 , uint256 , address ) view returns(uint256)
func (integrationId *IntegrationId) TryPackPrivilegeEntry(arg0 *big.Int, arg1 *big.Int, arg2 *big.Int, arg3 common.Address) ([]byte, error) {
	return integrationId.abi.Pack("privilegeEntry", arg0, arg1, arg2, arg3)
}
...
//
// Solidity: function privilegeEntry(uint256 , uint256 , uint256 , address ) view returns(uint256)
func (integrationId *IntegrationId) UnpackPrivilegeEntry(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("privilegeEntry", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
func (integrationId *IntegrationId) PackPrivilegeExpiresAt(tokenId *big.Int, privId *big.Int, user common.Address) []byte {
	enc, err := integrationId.abi.Pack("privilegeExpiresAt", tokenId, privId, user)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function privilegeExpiresAt(uint256 tokenId, uint256 privId, address user) view returns(uint256)
func (integrationId *IntegrationId) TryPackPrivilegeExpiresAt(tokenId *big.Int, privId *big.Int, user common.Address) ([]byte, error) {
	return integrationId.abi.Pack("privilegeExpiresAt", tokenId, privId, user)
}
...
//
// Solidity: function privilegeExpiresAt(uint256 tokenId, uint256 privId, address user) view returns(uint256)
func (integrationId *IntegrationId) UnpackPrivilegeExpiresAt(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("privilegeExpiresAt", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
func (integrationId *IntegrationId) PackPrivilegeRecord(arg0 *big.Int) []byte {
	enc, err := integrationId.abi.Pack("privilegeRecord", arg0)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function privilegeRecord(uint256 ) view returns(bool enabled, string description)
func (integrationId *IntegrationId) TryPackPrivilegeRecord(arg0 *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("privilegeRecord", arg0)
}
...
//
// Solidity: function privilegeRecord(uint256 ) view returns(bool enabled, string description)
func (integrationId *IntegrationId) UnpackPrivilegeRecord(data []byte) (PrivilegeRecordOutput, error) {
	out, err := integrationId.abi.Unpack("privilegeRecord", data)
...
func (integrationId *IntegrationId) PackProxiableUUID() []byte {
	enc, err := integrationId.abi.Pack("proxiableUUID")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (integrationId *IntegrationId) TryPackProxiableUUID() ([]byte, error) {
	return integrationId.abi.Pack("proxiableUUID")
}
...
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (integrationId *IntegrationId) UnpackProxiableUUID(data []byte) ([32]byte, error) {
	out, err := integrationId.abi.Unpack("proxiableUUID", data)
	if err != nil {
		return *new([32]byte), err
	}
	out0 := *abi.ConvertType(out[0], new([32]byte)).(*[32]byte)
...
func (integrationId *IntegrationId) PackRenounceRole(role [32]byte, account common.Address) []byte {
	enc, err := integrationId.abi.Pack("renounceRole", role, account)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function renounceRole(bytes32 role, address account) returns()
func (integrationId *IntegrationId) TryPackRenounceRole(role [32]byte, account common.Address) ([]byte, error) {
	return integrationId.abi.Pack("renounceRole", role, account)
}
...
func (integrationId *IntegrationId) PackRevokeRole(role [32]byte, account common.Address) []byte {
	enc, err := integrationId.abi.Pack("revokeRole", role, account)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function revokeRole(bytes32 role, address account) returns()
func (integrationId *IntegrationId) TryPackRevokeRole(role [32]byte, account common.Address) ([]byte, error) {
	return integrationId.abi.Pack("revokeRole", role, account)
}
...
func (integrationId *IntegrationId) PackSafeMint(to common.Address) []byte {
	enc, err := integrationId.abi.Pack("safeMint", to)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function safeMint(address to) returns(uint256 tokenId)
func (integrationId *IntegrationId) TryPackSafeMint(to common.Address) ([]byte, error) {
	return integrationId.abi.Pack("safeMint", to)
}
...
//
// Solidity: function safeMint(address to) returns(uint256 tokenId)
func (integrationId *IntegrationId) UnpackSafeMint(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("safeMint", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
func (integrationId *IntegrationId) PackSafeMint0(to common.Address, uri string) []byte {
	enc, err := integrationId.abi.Pack("safeMint0", to, uri)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function safeMint(address to, string uri) returns(uint256 tokenId)
func (integrationId *IntegrationId) TryPackSafeMint0(to common.Address, uri string) ([]byte, error) {
	return integrationId.abi.Pack("safeMint0", to, uri)
}
...
//
// Solidity: function safeMint(address to, string uri) returns(uint256 tokenId)
func (integrationId *IntegrationId) UnpackSafeMint0(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("safeMint0", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
func (integrationId *IntegrationId) PackSafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("safeTransferFrom", from, to, tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId) returns()
func (integrationId *IntegrationId) TryPackSafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("safeTransferFrom", from, to, tokenId)
}
...
func (integrationId *IntegrationId) PackSafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) []byte {
	enc, err := integrationId.abi.Pack("safeTransferFrom0", from, to, tokenId, data)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (integrationId *IntegrationId) TryPackSafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) ([]byte, error) {
	return integrationId.abi.Pack("safeTransferFrom0", from, to, tokenId, data)
}
...
func (integrationId *IntegrationId) PackSetApprovalForAll(operator common.Address, approved bool) []byte {
	enc, err := integrationId.abi.Pack("setApprovalForAll", operator, approved)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (integrationId *IntegrationId) TryPackSetApprovalForAll(operator common.Address, approved bool) ([]byte, error) {
	return integrationId.abi.Pack("setApprovalForAll", operator, approved)
}
...
func (integrationId *IntegrationId) PackSetBaseURI(baseURI string) []byte {
	enc, err := integrationId.abi.Pack("setBaseURI", baseURI)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setBaseURI(string baseURI_) returns()
func (integrationId *IntegrationId) TryPackSetBaseURI(baseURI string) ([]byte, error) {
	return integrationId.abi.Pack("setBaseURI", baseURI)
}
...
func (integrationId *IntegrationId) PackSetDimoRegistryAddress(dimoRegistry common.Address) []byte {
	enc, err := integrationId.abi.Pack("setDimoRegistryAddress", dimoRegistry)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setDimoRegistryAddress(address dimoRegistry_) returns()
func (integrationId *IntegrationId) TryPackSetDimoRegistryAddress(dimoRegistry common.Address) ([]byte, error) {
	return integrationId.abi.Pack("setDimoRegistryAddress", dimoRegistry)
}
...
func (integrationId *IntegrationId) PackSetPrivilege(tokenId *big.Int, privId *big.Int, user common.Address, expires *big.Int) []byte {
	enc, err := integrationId.abi.Pack("setPrivilege", tokenId, privId, user, expires)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setPrivilege(uint256 tokenId, uint256 privId, address user, uint256 expires) returns()
func (integrationId *IntegrationId) TryPackSetPrivilege(tokenId *big.Int, privId *big.Int, user common.Address, expires *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("setPrivilege", tokenId, privId, user, expires)
}
...
func (integrationId *IntegrationId) PackSetPrivileges(privData []MultiPrivilegeSetPrivilegeData) []byte {
	enc, err := integrationId.abi.Pack("setPrivileges", privData)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setPrivileges((uint256,uint256,address,uint256)[] privData) returns()
func (integrationId *IntegrationId) TryPackSetPrivileges(privData []MultiPrivilegeSetPrivilegeData) ([]byte, error) {
	return integrationId.abi.Pack("setPrivileges", privData)
}
...
func (integrationId *IntegrationId) PackSetTrustedForwarder(addr common.Address, trusted bool) []byte {
	enc, err := integrationId.abi.Pack("setTrustedForwarder", addr, trusted)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function setTrustedForwarder(address addr, bool trusted) returns()
func (integrationId *IntegrationId) TryPackSetTrustedForwarder(addr common.Address, trusted bool) ([]byte, error) {
	return integrationId.abi.Pack("setTrustedForwarder", addr, trusted)
}
...
func (integrationId *IntegrationId) PackSupportsInterface(interfaceId [4]byte) []byte {
	enc, err := integrationId.abi.Pack("supportsInterface", interfaceId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (integrationId *IntegrationId) TryPackSupportsInterface(interfaceId [4]byte) ([]byte, error) {
	return integrationId.abi.Pack("supportsInterface", interfaceId)
}
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (integrationId *IntegrationId) UnpackSupportsInterface(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("supportsInterface", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (integrationId *IntegrationId) PackSymbol() []byte {
	enc, err := integrationId.abi.Pack("symbol")
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function symbol() view returns(string)
func (integrationId *IntegrationId) TryPackSymbol() ([]byte, error) {
	return integrationId.abi.Pack("symbol")
}
...
//
// Solidity: function symbol() view returns(string)
func (integrationId *IntegrationId) UnpackSymbol(data []byte) (string, error) {
	out, err := integrationId.abi.Unpack("symbol", data)
	if err != nil {
		return *new(string), err
	}
	out0 := *abi.ConvertType(out[0], new(string)).(*string)
...
func (integrationId *IntegrationId) PackTokenIdToVersion(arg0 *big.Int) []byte {
	enc, err := integrationId.abi.Pack("tokenIdToVersion", arg0)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function tokenIdToVersion(uint256 ) view returns(uint256)
func (integrationId *IntegrationId) TryPackTokenIdToVersion(arg0 *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("tokenIdToVersion", arg0)
}
...
//
// Solidity: function tokenIdToVersion(uint256 ) view returns(uint256)
func (integrationId *IntegrationId) UnpackTokenIdToVersion(data []byte) (*big.Int, error) {
	out, err := integrationId.abi.Unpack("tokenIdToVersion", data)
	if err != nil {
		return new(big.Int), err
	}
	out0 := abi.ConvertType(out[0], new(big.Int)).(*big.Int)
...
func (integrationId *IntegrationId) PackTokenURI(tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("tokenURI", tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (integrationId *IntegrationId) TryPackTokenURI(tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("tokenURI", tokenId)
}
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (integrationId *IntegrationId) UnpackTokenURI(data []byte) (string, error) {
	out, err := integrationId.abi.Unpack("tokenURI", data)
	if err != nil {
		return *new(string), err
	}
	out0 := *abi.ConvertType(out[0], new(string)).(*string)
...
func (integrationId *IntegrationId) PackTransferFrom(from common.Address, to common.Address, tokenId *big.Int) []byte {
	enc, err := integrationId.abi.Pack("transferFrom", from, to, tokenId)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function transferFrom(address from, address to, uint256 tokenId) returns()
func (integrationId *IntegrationId) TryPackTransferFrom(from common.Address, to common.Address, tokenId *big.Int) ([]byte, error) {
	return integrationId.abi.Pack("transferFrom", from, to, tokenId)
}
...
func (integrationId *IntegrationId) PackTrustedForwarders(arg0 common.Address) []byte {
	enc, err := integrationId.abi.Pack("trustedForwarders", arg0)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function trustedForwarders(address ) view returns(bool)
func (integrationId *IntegrationId) TryPackTrustedForwarders(arg0 common.Address) ([]byte, error) {
	return integrationId.abi.Pack("trustedForwarders", arg0)
}
...
//
// Solidity: function trustedForwarders(address ) view returns(bool)
func (integrationId *IntegrationId) UnpackTrustedForwarders(data []byte) (bool, error) {
	out, err := integrationId.abi.Unpack("trustedForwarders", data)
	if err != nil {
		return *new(bool), err
	}
	out0 := *abi.ConvertType(out[0], new(bool)).(*bool)
...
func (integrationId *IntegrationId) PackUpgradeTo(newImplementation common.Address) []byte {
	enc, err := integrationId.abi.Pack("upgradeTo", newImplementation)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function upgradeTo(address newImplementation) returns()
func (integrationId *IntegrationId) TryPackUpgradeTo(newImplementation common.Address) ([]byte, error) {
	return integrationId.abi.Pack("upgradeTo", newImplementation)
}
...
func (integrationId *IntegrationId) PackUpgradeToAndCall(newImplementation common.Address, data []byte) []byte {
	enc, err := integrationId.abi.Pack("upgradeToAndCall", newImplementation, data)
	if err != nil {
		panic(err)
	}
	return enc
...
//
// Solidity: function upgradeToAndCall(address newImplementation, bytes data) payable returns()
func (integrationId *IntegrationId) TryPackUpgradeToAndCall(newImplementation common.Address, data []byte) ([]byte, error) {
	return integrationId.abi.Pack("upgradeToAndCall", newImplementation, data)
}

// IntegrationIdAdminChanged represents a AdminChanged event raised by the IntegrationId contract.
type IntegrationIdAdminChanged struct {
	PreviousAdmin common.Address
	NewAdmin      common.Address
	Raw           *types.Log // Blockchain specific contextual infos
}

const IntegrationIdAdminChangedEventName = "AdminChanged"

// ContractEventName returns the user-defined event name.
func (IntegrationIdAdminChanged) ContractEventName() string {
	return IntegrationIdAdminChangedEventName
}
...
func (integrationId *IntegrationId) UnpackAdminChangedEvent(log *types.Log) (*IntegrationIdAdminChanged, error) {
	event := "AdminChanged"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdAdminChanged)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
	}
	var indexed abi.Arguments
	for _, arg := range integrationId.abi.Events[event].Inputs {
		if arg.Indexed {
...
// IntegrationIdApproval represents a Approval event raised by the IntegrationId contract.
type IntegrationIdApproval struct {
...
const IntegrationIdApprovalEventName = "Approval"

// ContractEventName returns the user-defined event name.
func (IntegrationIdApproval) ContractEventName() string {
	return IntegrationIdApprovalEventName
}
...
func (integrationId *IntegrationId) UnpackApprovalEvent(log *types.Log) (*IntegrationIdApproval, error) {
	event := "Approval"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdApproval)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdApprovalForAll represents a ApprovalForAll event raised by the IntegrationId contract.
type IntegrationIdApprovalForAll struct {
	Owner    common.Address
...
const IntegrationIdApprovalForAllEventName = "ApprovalForAll"

// ContractEventName returns the user-defined event name.
func (IntegrationIdApprovalForAll) ContractEventName() string {
	return IntegrationIdApprovalForAllEventName
}
...
func (integrationId *IntegrationId) UnpackApprovalForAllEvent(log *types.Log) (*IntegrationIdApprovalForAll, error) {
	event := "ApprovalForAll"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdApprovalForAll)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdBatchMetadataUpdate represents a BatchMetadataUpdate event raised by the IntegrationId contract.
type IntegrationIdBatchMetadataUpdate struct {
	FromTokenId *big.Int
	ToTokenId   *big.Int
	Raw         *types.Log // Blockchain specific contextual infos
}

const IntegrationIdBatchMetadataUpdateEventName = "BatchMetadataUpdate"

// ContractEventName returns the user-defined event name.
func (IntegrationIdBatchMetadataUpdate) ContractEventName() string {
	return IntegrationIdBatchMetadataUpdateEventName
}
...
func (integrationId *IntegrationId) UnpackBatchMetadataUpdateEvent(log *types.Log) (*IntegrationIdBatchMetadataUpdate, error) {
	event := "BatchMetadataUpdate"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdBatchMetadataUpdate)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdBeaconUpgraded represents a BeaconUpgraded event raised by the IntegrationId contract.
type IntegrationIdBeaconUpgraded struct {
	Beacon common.Address
	Raw    *types.Log // Blockchain specific contextual infos
}

const IntegrationIdBeaconUpgradedEventName = "BeaconUpgraded"

// ContractEventName returns the user-defined event name.
func (IntegrationIdBeaconUpgraded) ContractEventName() string {
	return IntegrationIdBeaconUpgradedEventName
}
...
func (integrationId *IntegrationId) UnpackBeaconUpgradedEvent(log *types.Log) (*IntegrationIdBeaconUpgraded, error) {
	event := "BeaconUpgraded"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdBeaconUpgraded)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdInitialized represents a Initialized event raised by the IntegrationId contract.
type IntegrationIdInitialized struct {
	Version uint8
	Raw     *types.Log // Blockchain specific contextual infos
}

const IntegrationIdInitializedEventName = "Initialized"

// ContractEventName returns the user-defined event name.
func (IntegrationIdInitialized) ContractEventName() string {
	return IntegrationIdInitializedEventName
}
...
func (integrationId *IntegrationId) UnpackInitializedEvent(log *types.Log) (*IntegrationIdInitialized, error) {
	event := "Initialized"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdInitialized)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdMetadataUpdate represents a MetadataUpdate event raised by the IntegrationId contract.
type IntegrationIdMetadataUpdate struct {
	TokenId *big.Int
	Raw     *types.Log // Blockchain specific contextual infos
}

const IntegrationIdMetadataUpdateEventName = "MetadataUpdate"

// ContractEventName returns the user-defined event name.
func (IntegrationIdMetadataUpdate) ContractEventName() string {
	return IntegrationIdMetadataUpdateEventName
}
...
func (integrationId *IntegrationId) UnpackMetadataUpdateEvent(log *types.Log) (*IntegrationIdMetadataUpdate, error) {
	event := "MetadataUpdate"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdMetadataUpdate)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdPrivilegeCreated represents a PrivilegeCreated event raised by the IntegrationId contract.
type IntegrationIdPrivilegeCreated struct {
	PrivilegeId *big.Int
	Enabled     bool
	Description string
	Raw         *types.Log // Blockchain specific contextual infos
...
const IntegrationIdPrivilegeCreatedEventName = "PrivilegeCreated"

// ContractEventName returns the user-defined event name.
func (IntegrationIdPrivilegeCreated) ContractEventName() string {
	return IntegrationIdPrivilegeCreatedEventName
}
...
func (integrationId *IntegrationId) UnpackPrivilegeCreatedEvent(log *types.Log) (*IntegrationIdPrivilegeCreated, error) {
	event := "PrivilegeCreated"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdPrivilegeCreated)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdPrivilegeDisabled represents a PrivilegeDisabled event raised by the IntegrationId contract.
type IntegrationIdPrivilegeDisabled struct {
	PrivilegeId *big.Int
	Raw         *types.Log // Blockchain specific contextual infos
}

const IntegrationIdPrivilegeDisabledEventName = "PrivilegeDisabled"

// ContractEventName returns the user-defined event name.
func (IntegrationIdPrivilegeDisabled) ContractEventName() string {
	return IntegrationIdPrivilegeDisabledEventName
}
...
func (integrationId *IntegrationId) UnpackPrivilegeDisabledEvent(log *types.Log) (*IntegrationIdPrivilegeDisabled, error) {
	event := "PrivilegeDisabled"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdPrivilegeDisabled)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdPrivilegeEnabled represents a PrivilegeEnabled event raised by the IntegrationId contract.
type IntegrationIdPrivilegeEnabled struct {
	PrivilegeId *big.Int
	Raw         *types.Log // Blockchain specific contextual infos
}

const IntegrationIdPrivilegeEnabledEventName = "PrivilegeEnabled"

// ContractEventName returns the user-defined event name.
func (IntegrationIdPrivilegeEnabled) ContractEventName() string {
	return IntegrationIdPrivilegeEnabledEventName
}
...
func (integrationId *IntegrationId) UnpackPrivilegeEnabledEvent(log *types.Log) (*IntegrationIdPrivilegeEnabled, error) {
	event := "PrivilegeEnabled"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdPrivilegeEnabled)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdPrivilegeSet represents a PrivilegeSet event raised by the IntegrationId contract.
type IntegrationIdPrivilegeSet struct {
	TokenId *big.Int
	Version *big.Int
	PrivId  *big.Int
	User    common.Address
...
const IntegrationIdPrivilegeSetEventName = "PrivilegeSet"

// ContractEventName returns the user-defined event name.
func (IntegrationIdPrivilegeSet) ContractEventName() string {
	return IntegrationIdPrivilegeSetEventName
}
...
func (integrationId *IntegrationId) UnpackPrivilegeSetEvent(log *types.Log) (*IntegrationIdPrivilegeSet, error) {
	event := "PrivilegeSet"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdPrivilegeSet)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdRoleAdminChanged represents a RoleAdminChanged event raised by the IntegrationId contract.
type IntegrationIdRoleAdminChanged struct {
	Role              [32]byte
...
const IntegrationIdRoleAdminChangedEventName = "RoleAdminChanged"

// ContractEventName returns the user-defined event name.
func (IntegrationIdRoleAdminChanged) ContractEventName() string {
	return IntegrationIdRoleAdminChangedEventName
}
...
func (integrationId *IntegrationId) UnpackRoleAdminChangedEvent(log *types.Log) (*IntegrationIdRoleAdminChanged, error) {
	event := "RoleAdminChanged"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdRoleAdminChanged)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdRoleGranted represents a RoleGranted event raised by the IntegrationId contract.
type IntegrationIdRoleGranted struct {
	Role    [32]byte
...
const IntegrationIdRoleGrantedEventName = "RoleGranted"

// ContractEventName returns the user-defined event name.
func (IntegrationIdRoleGranted) ContractEventName() string {
	return IntegrationIdRoleGrantedEventName
}
...
func (integrationId *IntegrationId) UnpackRoleGrantedEvent(log *types.Log) (*IntegrationIdRoleGranted, error) {
	event := "RoleGranted"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdRoleGranted)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdRoleRevoked represents a RoleRevoked event raised by the IntegrationId contract.
type IntegrationIdRoleRevoked struct {
	Role    [32]byte
	Account common.Address
	Sender  common.Address
	Raw     *types.Log // Blockchain specific contextual infos
...
const IntegrationIdRoleRevokedEventName = "RoleRevoked"

// ContractEventName returns the user-defined event name.
func (IntegrationIdRoleRevoked) ContractEventName() string {
	return IntegrationIdRoleRevokedEventName
}
...
func (integrationId *IntegrationId) UnpackRoleRevokedEvent(log *types.Log) (*IntegrationIdRoleRevoked, error) {
	event := "RoleRevoked"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdRoleRevoked)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdTransfer represents a Transfer event raised by the IntegrationId contract.
type IntegrationIdTransfer struct {
	From    common.Address
	To      common.Address
	TokenId *big.Int
	Raw     *types.Log // Blockchain specific contextual infos
...
const IntegrationIdTransferEventName = "Transfer"

// ContractEventName returns the user-defined event name.
func (IntegrationIdTransfer) ContractEventName() string {
	return IntegrationIdTransferEventName
}
...
func (integrationId *IntegrationId) UnpackTransferEvent(log *types.Log) (*IntegrationIdTransfer, error) {
	event := "Transfer"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdTransfer)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// IntegrationIdUpgraded represents a Upgraded event raised by the IntegrationId contract.
type IntegrationIdUpgraded struct {
	Implementation common.Address
	Raw            *types.Log // Blockchain specific contextual infos
}

const IntegrationIdUpgradedEventName = "Upgraded"

// ContractEventName returns the user-defined event name.
func (IntegrationIdUpgraded) ContractEventName() string {
	return IntegrationIdUpgradedEventName
}
...
func (integrationId *IntegrationId) UnpackUpgradedEvent(log *types.Log) (*IntegrationIdUpgraded, error) {
	event := "Upgraded"
	if len(log.Topics) == 0 || log.Topics[0] != integrationId.abi.Events[event].ID {
		return nil, errors.New("event signature mismatch")
	}
	out := new(IntegrationIdUpgraded)
	if len(log.Data) > 0 {
		if err := integrationId.abi.UnpackIntoInterface(out, event, log.Data); err != nil {
			return nil, err
		}
...
// error definitions.
func (integrationId *IntegrationId) UnpackError(raw []byte) (any, error) {
	if bytes.Equal(raw[:4], integrationId.abi.Errors["ZeroAddress"].ID.Bytes()[:4]) {
		return integrationId.UnpackZeroAddressError(raw[4:])
	}
	return nil, errors.New("Unknown error")
}

// IntegrationIdZeroAddress represents a ZeroAddress error raised by the IntegrationId contract.
type IntegrationIdZeroAddress struct {
}

// ErrorID returns the hash of canonical representation of the error's signature.
//
// Solidity: error ZeroAddress()
func IntegrationIdZeroAddressErrorID() common.Hash {
...
//
// Solidity: error ZeroAddress()
func (integrationId *IntegrationId) UnpackZeroAddressError(raw []byte) (*IntegrationIdZeroAddress, error) {
	out := new(IntegrationIdZeroAddress)
	if err := integrationId.abi.UnpackIntoInterface(out, "ZeroAddress", raw); err != nil {
		return nil, err
	}
	return out, nil
}
