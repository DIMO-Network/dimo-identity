  ...
  describe('mintAftermarketDeviceByManufacturerBatch', () => {
    ...
    context('State change', () => {
      it('Should correctly set parent node', async () => {
        ...
        const parentNode1 = await nodesInstance.getParentNode(adNftInstance.address, 1);
        const parentNode2 = await nodesInstance.getParentNode(adNftInstance.address, 2);
